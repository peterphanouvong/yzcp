...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"classes/Page.ts":[function(require,module,exports) {
"use strict";
...
var Page = function () {
  function Page(props) {
    ...
    this.canScroll = (_a = props.canScroll) !== null && _a !== void 0 ? _a : true;
    console.log(this.element);
    this.render();
    this.addEventListeners();
  }

  Page.prototype.changeBackgroundColor = function (color) {
  ...
  Page.prototype.wheel = function (_a) {
  ...
  Page.prototype.removeEventListeners = function () {
  ...
  Page.prototype.render = function () {
    this.scrollPosition.current.y = gsap_1.default.utils.interpolate(this.scrollPosition.current.y, this.scrollPosition.target.y, 0.08);
    this.scrollPosition.target.y = gsap_1.default.utils.clamp(0, this.element.offsetHeight - window.innerHeight, this.scrollPosition.target.y);
...
exports.Page = Page;
},{"gsap":"../node_modules/gsap/index.js"}],"pages/Home.ts":[function(require,module,exports) {
"use strict";
...
var Home = function (_super) {
  ...
  function Home() {
    ...
    _this.albumList = document.querySelector("ul.home__album__titles");
    _this.albumMedia = document.querySelectorAll("figure.home__album__media");
  ...
  Home.prototype.rotateImages = function () {
    this.albumMedia.forEach(function (album, index) {
      album.style.transform = "translate(-50%, -50%) rotate(" + (Math.random() - 0.5) * (10 + index ^ 2) + "deg) translate(" + (Math.random() - 0.5) * 30 + "px, " + (Math.random() - 0.5) * 30 + "px)";
    });
  };

  Home.prototype.bringImageToFront = function (id) {
    this.albumMedia.forEach(function (media, index) {
      if (media.getAttribute("data-id") === id) {
        ...
        gsap_1.default.timeline().to(media, {
          scale: 1,
          transform: "translate(-50%, -50%) rotate(" + (Math.random() - 0.5) * (10 + index ^ 2) + "deg) translate(" + (Math.random() - 0.5) * 30 + "px, " + (Math.random() - 0.5) * 30 + "px)"
        });
        media.style.zIndex = "";
      }
    });
  ...
  Home.prototype.handleMouseOver = function (element) {
    this.changeBackgroundColor(element.getAttribute("data-color"));
    this.bringImageToFront(element.getAttribute("data-id"));
  };

  Home.prototype.handleMouseOut = function (element) {// element.style.opacity = "0.8";
  };

  Home.prototype.addEventListeners = function () {
    var _this = this;

    _super.prototype.addEventListeners.call(this);

    if (this.albumList) {
      var albumListElements = __spreadArray([], this.albumList.children, true);

      albumListElements.forEach(function (element) {
        element.firstChild.addEventListener("mouseover", _this.handleMouseOver.bind(_this, element.firstChild));
        element.firstChild.addEventListener("mouseout", _this.handleMouseOut.bind(_this, element.firstChild));
      });
    }
  };
...
exports.Home = Home;
},{"../classes/Page":"classes/Page.ts","gsap":"../node_modules/gsap/index.js"}],"../node_modules/@barba/core/dist/barba.umd.js":[function(require,module,exports) {
var define;
...
var core_1 = __importDefault(require("@barba/core"));
...
var App = function () {
  ...
  App.prototype.barba = function () {
    core_1.default.init({
      transitions: [{
        name: "default-transition",
        leave: function leave(data) {
          var tl = gsap_1.default.timeline();
          return tl.fromTo(".transition-element", {
            y: "100%"
          }, {
            y: 0
        ...
        enter: function enter(data) {
          var tl = gsap_1.default.timeline();
          return tl.to(".transition-element", {
            y: "-100%",
            delay: 0.2
  ...
  App.prototype.createPages = function () {
    this.pages = {
...
new App();
},{"./pages/Home":"pages/Home.ts","@barba/core":"../node_modules/@barba/core/dist/barba.umd.js","gsap":"../node_modules/gsap/index.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
